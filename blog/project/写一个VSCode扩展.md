...
![](https://img.kuizuo.me/StiMqQrFCi.png)
...
![](https://img.kuizuo.me/Yv4X32qLE5.png)
...
export function activate(context: vscode.ExtensionContext) {
  vscode.window
    .showInformationMessage('是否要打开淬己的小站？', '是', '否', '不再提示')
    .then(result => {
      if (result === '是') {
        exec(`start 'https://kuizuo.me'`)
      } else if (result === '不再提示') {
        // 其他操作 后文会说
      }
    })
...
![](https://img.kuizuo.me/9oqLzZl-wE.png)
...
const commandLine = os.platform() === 'win32' ? `start https://kuizuo.me` : `open https://kuizuo.me`
exec(commandLine)
```
...
![](https://img.kuizuo.me/teNrxe9D9O.png)
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  if (showTip) {
    ...
    if (result === '是') {
      const commandLine =
        os.platform() === 'win32' ? `start https://kuizuo.me` : `open https://kuizuo.me`
      exec(commandLine)
    } else if (result === '不再提示') {
...
![](https://img.kuizuo.me/3SRybBGaF1.png)
...
![](https://img.kuizuo.me/nQu3Y8DWSw.png)
...
![](https://img.kuizuo.me/SnnPUABJN5.png)
...
![](https://img.kuizuo.me/yQRsMkT6f5.png)
...
![](https://img.kuizuo.me/-ZCy88xVyq.png)
...
![](https://img.kuizuo.me/RUIjdDI90l.png)
...
![](https://img.kuizuo.me/nVO_YmRit4.png)
...
![](https://img.kuizuo.me/token1_JNXknLPQyJ.png)
...
![](https://img.kuizuo.me/HssaMdar8f.png)
...
![vscode-extension](https://img.kuizuo.me/20220711195038039.png)
